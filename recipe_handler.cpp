...
void Recipe_Handler::split_text(char * in_text, Recipe * recipe) // for splitting the line
{
...
void Recipe_Handler::start_line(char * line, Recipe * recipe)
{
...
void file_read(Recipe_Handler& csv_handler)
{
...
int main()
{
    char filename[20] = "RECIPES1.csv";
    
    cout<<"\t___________________RECIPES_____________________\n\n"<<endl;
   
    Recipe_Handler csv_handler(filename);
